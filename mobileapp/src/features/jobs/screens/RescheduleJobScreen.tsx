...
export function RescheduleJobScreen({ jobId }: RescheduleJobScreenProps) {
  ...
  // Pinned below the scroll by KeyboardFlow, which lifts it onto the keyboard
  // while the customer's code is typed rather than leaving it under the keys.
  const actionBar = (
  ...
  return (
    <View style={{ flex: 1, backgroundColor: color.surface }}>
      ...
      <KeyboardFlow
        footer={actionBar}
        // The bar is white on this grey screen, so its colour and top border go
        // on the strip, which also covers the navigation-bar clearance under it.
        footerStyle={{
