 ...
 * `redemption` is work too — a technician waiting to be paid, or saying a
 * payment never arrived — and only the payer ever sees it, so it sits there.
 * The three brand kinds mirror the three product ones, each beside its twin.
 *
...
export const NOTIFICATION_KINDS = [
  ...
  "upi_change",
  // The company's own credits — tickets paused, or about to be — and the
